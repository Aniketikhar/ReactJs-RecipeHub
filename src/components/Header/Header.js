      ...
      <div className={`row ${isDarkMode ? "header-dark header" : "header"}`}>
        ...
        <div className="col-12 col-md-5">
          <div className="content m-3 p-4">
            ...
            <Link
              className={`heading ${isDarkMode ? "text-white" : "text-black"}`}
              to={`/recipes/${item.idMeal}`}
            >
              <h1>{item.strMeal}</h1>
            </Link>
            <p className="">
              Delightful combination of creamy custard infused with the sweet
              flavor of white chocolate, topped with a satisfyingly crisp
